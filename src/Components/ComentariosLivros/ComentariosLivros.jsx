...
function ComentariosLivros() {

    const livro = useParams();
    const baseUrl = `/Book/${livro.bookId}/Comments`;
    ...
    return (
        <>
            <div className='comment-bg'>
                ...
                <ul className='comment-list'>{comentarios.map(livro =>
                    <li className='comment even thread-even parent'>
                        <div className='comment-body'>
                            <div className='comment-author vcard'>
                                <b className='fn'>
                                    <p><b>{livro.userName}</b> - <b>{livro.datePosting} </b></p>
                                </b>
                            </div>
